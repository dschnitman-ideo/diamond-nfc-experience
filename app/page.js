  ...
  return (
    <main className="mx-auto flex min-h-screen w-full max-w-md flex-col justify-center px-6 py-16 text-[var(--ink)]">
      ...
      <p className="mt-3 text-sm leading-relaxed text-[var(--ink-soft)]">
        ...
        opens its unique URL directly — no index page involved. This screen
        stands in for that tap. Pick a sample stone below to simulate
        scanning its tag.
      </p>
          ...
          >
            <span>
              ...
              <span className="block text-xs text-[var(--ink-faint)]">
                {d.shape} · {d.carat.toFixed(2)} ct · /diamond/{d.id}
              </span>
            </span>
